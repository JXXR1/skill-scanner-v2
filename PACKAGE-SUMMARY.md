...
**Location:** `<workspace>/skill-scanner-v2-package/`
...
```bash
cd <workspace>/skill-scanner-v2-package
git init
git add .
...
- Moltbook (Agent can post to m/general)
...
- Positions you as security leaders in AI agent community
